...
#直接运行python3 compile_shaders.py，路径参数已经配好
...
samplesdir = os.path.join(os.getcwd(), "app", "src", "main", "shaders")
headersdir = os.path.join(os.getcwd(), "app", "src", "main", "cpp", "ShaderHeaders")
